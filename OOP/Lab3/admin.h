...
class Admin: public Person, public Info_Interface{
    private:
        int office_num;
    ...
    // Writes all admin information to a formatted string (Implaments Info_Interface)
    string Info();

    // Returns admin name as a String
