...
int main(int, char**) {
    ...
    minibb.admins.at(0).Add_CourseInst(Course_Inst (2020,1,"Vag- och materiefysik for civilingenjorer", "FY501G",6), minibb);
    ...
    for(int i = 0; i<5; i++){
        cout << "Testing student " << minibb.students.at(i).Get_Name() << "\n" << endl;
        minibb.Print_Info(minibb.students.at(i));
        minibb.Print_Courses(minibb.students.at(i).What_Courses());
        cout << endl;
    }
    
    for(int i = 0; i<4; i++){
        cout << "Testing Teacher " << minibb.students.at(i).Get_Name() << "\n" << endl;
        minibb.Print_Info(minibb.teachers.at(i));
        minibb.Print_Courses(minibb.teachers.at(i).What_Courses());
        cout << endl;
    }
    ...
    cout << "Testing Print Participants Info function" << endl;
    minibb.Print_Participants_Info(minibb.course_inst.at(0));
